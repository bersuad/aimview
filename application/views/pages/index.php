<div class="wm-main-banner">
    ...
    <div class="wm-banner-one">
        <div class="wm-banner-one-for">
            <div class="wm-banner-one-for-layer"> <img src="<?php echo base_url()?>assets/images/banner/banner-1.jpg" alt=""> </div>
            <div class="wm-banner-one-for-layer"> <img src="<?php echo base_url()?>assets/images/banner/banner-3.png" alt=""> </div>
            <div class="wm-banner-one-for-layer"> <img src="<?php echo base_url()?>assets/images/banner/about-us.jpg" alt=""> </div>
            <div class="wm-banner-one-for-layer"> <img src="<?php echo base_url()?>assets/images/banner/banner-2.jpg" alt=""> </div>
        </div>
        <div class="wm-banner-one-nav">
            <div class="wm-banner-one-nav-layer">
                <h1>Our bright future is our mission</h1>
                <p>Educating and connecting students to make informed and wise career choices.</p>
                <a href="#" class="wm-banner-btn">learn more</a>
            </div>
            <div class="wm-banner-one-nav-layer">
                <h1>OUR AIM</h1>
                <p>
                Engage every learner in challenging opportunities appropriate to their needs. <br>
                - Create direct network with international education institutes and recruitment 
            ...
            <div class="wm-banner-one-nav-layer banner-bgcolor">
                <h1>Creating Paper Free, Streamlined and Automated Education System</h1>
                <p>
                Enable counselors spend most of their time in 
                building relationship empathizing the needs and 
                expectations: students, parents, related institutes/agencies.
                </p>
                <a href="#" class="wm-banner-btn">learn more</a>
            </div>
            <div class="wm-banner-one-nav-layer">
                                ...
                                <ul class="row">
                                    <li class="col-md-4">
                                        <div class="wm-courses-popular-wrap">
                                            <figure> <a href="#"><img src="<?php echo base_url()?>assets/images/course/01.jpg" alt=""> <span class="wm-popular-hover"> <small>see course</small> </span> </a>
                                                <figcaption>
                                                    <!-- <img src="<?php echo base_url()?>assets/extra-images/papular-courses-thumb-1.jpg" alt=""> -->
                                    ...
                                    <li class="col-md-4">
                                        <div class="wm-courses-popular-wrap">
                                            <figure> <a href="#"><img src="<?php echo base_url()?>assets/images/course/02.jpg" alt=""> <span class="wm-popular-hover"> <small>see course</small> </span> </a>
                                                <figcaption>
                                                    <!-- <img src="<?php echo base_url()?>assets/extra-images/papular-courses-thumb-2.jpg" alt=""> -->
                                                    <h6><a href="#">Training and Development</a></h6>
                                                </figcaption>
                                            </figure>
                                            <!-- <div class="wm-popular-courses-text">
                                                <h6><a href="#">Academic Competition</a></h6>
                                    ...
                                    <li class="col-md-4">
                                        <div class="wm-courses-popular-wrap">
                                            <figure> <a href="#"><img src="<?php echo base_url()?>assets/images/course/03.jpg" alt=""> <span class="wm-popular-hover"> <small>see course</small> </span> </a>
                                                <figcaption>
                                                    <!-- <img src="<?php echo base_url()?>assets/extra-images/papular-courses-thumb-3.jpg" alt=""> -->
                                                    <h6><a href="#">Research and Development</a></h6>
                                                </figcaption>
                                            </figure>
                                            <!-- <div class="wm-popular-courses-text">
                    ...
                    <div class="row">
                            ...
                            <div class="whychooseus-list">
                                ...
                                <ul class="row">
                                    <li class="col-md-5">
                                        ...
                                        <h6>Our approach enables a school to design a clear and flexible strategic plan focused on effective learning; 
                                            we also support schools in waiting their mission to achieve the excellence described in their vision.</h6>
                                    </li>
                                    <li class="col-md-6">
                                        <span>DIGITAL AGENCY</span></h4>
                                        <h6>Schools, students, parents, teachers and other school technicians need knowledge with qualified education environment. 
                                            All want to find the best resources. Our crafted digital marketing brings them together.</h6>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="wm-questions-studying">
                                <img src="<?php echo base_url()?>assets/images/logo/vertical_logo.png" alt="" style="width:60%;">
                                <h3 class="wm-color" style="margin-top:-10%!important;">Why Aim View?</h3>
                                <p>Aim View General Educational Consultancy & Support is one of the leading consultants ensures that once a client joins hands with us doesn't have to regret that decision. We make students radically opting for international education as a part of their career and make sure that they excel at it.</p>
                                <a class="wm-banner-btn" href="#">Learn More</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="wm-learn-listing">
                                <ul class="row">
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="<?php echo base_url()?>assets/extra-images/learn-listing-1.png" alt=""></a>
                                            <figcaption>
                                                <h2>Research</h2>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="<?php echo base_url()?>assets/extra-images/learn-listing-2.png" alt=""></a>
                                            <figcaption>
                                                <h2>Academics</h2>
                                                <a href="#" class="wm-banner-btn">Read More</a>
                                            </figcaption>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="<?php echo base_url()?>assets/extra-images/learn-listing-3.png" alt=""></a>
                                            <figcaption>
                                                <h2>Admissions</h2>
                                                <a href="#" class="wm-banner-btn">Read More</a>
                                            </figcaption>
                                    ...
                                    <li class="col-md-6">
                                        <figure><a href="#"><img src="<?php echo base_url()?>assets/extra-images/learn-listing-4.png" alt=""></a>
                                            <figcaption>
                                                <h2>Student Life</h2>
                                                <a href="#" class="wm-banner-btn">Read More</a>
                                            </figcaption>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="wm-event wm-latest-event">
                                        <ul class="row">
                                            <li class="col-md-12">
                                                <figure><a href="#"><img src="<?php echo base_url()?>assets/extra-images/latest-event-1.png" alt=""></a></figure>
                                ...
                                <div class="col-md-4">
                                    <div class="wm-event wm-latest-event">
                                        <ul class="row">
                                            <li class="col-md-12">
                                                <figure><a href="#"><img src="<?php echo base_url()?>assets/extra-images/latest-event-2.png" alt=""></a></figure>
                                                <div class="wm-latest-event-text">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="wm-testimonial-slider">
                                <div class="wm-testimonial-slider-wrap">
                                    ...
                                    <figure>
                                        <a href="#" class="wm-testimonial-thumb"><img src="<?php echo base_url()?>assets/extra-images/testimonial-thumb-1.png" alt=""></a>
                                ...
                                <div class="wm-testimonial-slider-wrap">
                                    ...
                                    <figure>
                                        <a href="#" class="wm-testimonial-thumb"><img src="<?php echo base_url()?>assets/extra-images/testimonial-thumb-2.png" alt=""></a>
                                        <figcaption> <h5><a href="#">Priya E. Abraham</a></h5> <span>Paris, France</span> </figcaption>
                                    </figure>
                                </div>
                                <div class="wm-testimonial-slider-wrap">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="wm-news wm-news-grid">
                                <ul class="row">
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="<?php echo base_url()?>assets/extra-images/news-grid-1.png" alt=""></a>
                                            <figcaption class="wm-bgcolor">
                                                <img src="<?php echo base_url()?>assets/extra-images/news-grid-thumb-1.png" alt="">
                                    ...
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="<?php echo base_url()?>assets/extra-images/news-grid-2.png" alt=""></a>
                                            <figcaption class="wm-bgcolor">
                                                <img src="<?php echo base_url()?>assets/extra-images/news-grid-thumb-2.png" alt="">
                                    ...
                                    <li class="col-md-4">
                                        <figure>
                                            <a href="#"><img src="<?php echo base_url()?>assets/extra-images/news-grid-3.png" alt=""></a>
                                            <figcaption class="wm-bgcolor">
                                                <img src="<?php echo base_url()?>assets/extra-images/news-grid-thumb-3.png" alt="">
            ...
            <div class="wm-main-section">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="wm-simple-section-title wm-partners-title"> <h2>Aim View <span>Partners</span></h2> </div>
                            <div class="wm-partners-slider gallery">
                                <div class="wm-partners-layer"> <a title="" data-rel="prettyPhoto[gallery1]" href="<?php echo base_url()?>assets/images/partners/enat.jpg"> <img src="<?php echo base_url()?>assets/images/partners/enat.jpg" alt=""> </a> </div>
                                <div class="wm-partners-layer"> <a title="" data-rel="prettyPhoto[gallery1]" href="<?php echo base_url()?>assets/images/partners/telecom.jpg"> <img src="<?php echo base_url()?>assets/images/partners/telecom.jpg" alt=""> </a> </div>
                                <div class="wm-partners-layer"> <a title="" data-rel="prettyPhoto[gallery1]" href="<?php echo base_url()?>assets/images/partners/mlec.jpg"> <img src="<?php echo base_url()?>assets/images/partners/mlec.jpg" alt=""> </a> </div>
                                <div class="wm-partners-layer"> <a title="" data-rel="prettyPhoto[gallery1]" href="<?php echo base_url()?>assets/images/partners/growth.jpg"> <img src="<?php echo base_url()?>assets/images/partners/growth.jpg" alt=""> </a> </div>
                                <div class="wm-partners-layer"> <a title="" data-rel="prettyPhoto[gallery1]" href="<?php echo base_url()?>assets/images/partners/Fana.jpg"> <img src="<?php echo base_url()?>assets/images/partners/Fana.jpg" alt=""> </a> </div>
                                <div class="wm-partners-layer"> <a title="" data-rel="prettyPhoto[gallery1]" href="<?php echo base_url()?>assets/images/university-partners-6.png"> <img src="<?php echo base_url()?>assets/extra-images/university-partners-6.png" alt=""> </a> </div>
                                <div class="wm-partners-layer"> <a title="" data-rel="prettyPhoto[gallery1]" href="<?php echo base_url()?>assets/images/university-partners-1.png"> <img src="<?php echo base_url()?>assets/extra-images/university-partners-1.png" alt=""> </a> </div>
                            </div>
                        </div>
                            ...
                            <div class="wm-contact-tab">
                              ...
                              <div class="tab-content">
                                <div class="tab-pane active" id="home">
                                    <div class="row">
                                        <div class="col-md-4"> <div class="wm-map"> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2511.9067547409345!2d38.74679316686532!3d9.00776313916182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b85d0181f146d%3A0xbe3dcdd55e6fe2c6!2sKKare%20Building!5e0!3m2!1sen!2set!4v1620379246016!5m2!1sen!2set" width="auto" height="auto" style="border:0;" allowfullscreen="" loading="lazy" id="map"></iframe></div> </div>
                                        <div class="col-md-8">
